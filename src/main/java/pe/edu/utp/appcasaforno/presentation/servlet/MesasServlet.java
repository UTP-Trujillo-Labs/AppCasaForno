...
import pe.edu.utp.appcasaforno.presentation.handler.mesas.CobrarMesaHandler;
...
public class MesasServlet extends ApiServlet {
    ...
    public MesasServlet(MesasServicio mesasServicio) {
        super(
                ...
                Map.of(
                        "/{numero}", new ActualizarMesaHandler(mesasServicio),
                        "/{numero}/pagar", new CobrarMesaHandler(mesasServicio)));
    }
}
