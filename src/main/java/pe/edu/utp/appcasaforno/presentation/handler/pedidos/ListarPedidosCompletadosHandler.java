...
public class ListarPedidosCompletadosHandler implements ApiHandler {

    private final PedidosService pedidosService;

    public ListarPedidosCompletadosHandler(PedidosService pedidosService) {
        this.pedidosService = pedidosService;
    }

    @Override
    public void handle(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        JsonUtil.write(resp, pedidosService.listarPedidosPorEstado(EstadoPedido.COMPLETADO));
    }
}
